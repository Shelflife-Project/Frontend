export default function CreateButton({ onClick }: { onClick: () => void }) {
    return (
        <button
            onClick={onClick}
            className="fixed bottom-0 right-0 mb-5 me-1 sm:me-2 z-60 btn btn-ghost btn-circle w-8 sm:w-10">
...
export function CreateButtonWithOutClick({ onClick }: { onClick?: () => void }) {
    return (
        <button
            onClick={onClick}
            className="fixed bottom-0 right-0 mb-5 me-1 sm:me-2 z-60 btn btn-ghost btn-circle w-8 sm:w-10">
