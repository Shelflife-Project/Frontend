...
export default function ShoppingList() {
    const { aboutToExpireItems, fetchAboutToExpireAggregated, isLoading, isError, deleteItem } = useStorageItems();
    ...
    return (
        <ul className="list bg-base-200 rounded-box shadow-md max-h-64">
            ...
            <span className="overflow-x-hidden">
                {
                    aboutToExpireItems.sort((a, b) => new Date(a.expiresAt).getTime() - new Date(b.expiresAt).getTime()).map((x, i) =>
